...
class MCPConfig:
    ...
    class Session:
        ...
        # Orphaned process cleanup interval in seconds
        CLEANUP_INTERVAL = int(os.getenv("MCP_PROCESS_CLEANUP_INTERVAL", 300))  # 5 minutes
    ...
    class MCP:
        ...
        SERVER_SCRIPT = os.getenv("MCP_SERVER_SCRIPT", "src/python/insight_digger_mcp/mcp_server/server.py")
